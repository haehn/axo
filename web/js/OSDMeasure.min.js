...
//                this.measurementList.removeSelectedMeasurement(this.selectedMeasurement); // Remove from the list

                // Remove it from the database
                this.redoStack.push(this.selectedMeasurement);
                this.db.removeMeasurement(this.selectedMeasurement, this.imageIdentifier);
                this.saveInLocalStorage(this.imageIdentifier);
                document.dispatchEvent(new Event("delete-selected-measurement"));
 ...
 class $9aede8581b16c941$var$Measurement {
    ...
    select() {
        this.line.set({
            stroke: "red" // Highlight the selected measurement with a red stroke (you can customize this)
        });
        this.fabricCanvas.renderAll();
    }
 ...
 class $9aede8581b16c941$var$MeasurementList {
    ...
    listItems = [];
     constructor(plugin){
        ...
        document.addEventListener("delete-selected-measurement",this.removeSelectedMeasurement.bind(this));
    }
    addAllMeasurements() {
    ...
    this.element.removeChild(this.listItems[measurement.id].element);
    }
}
